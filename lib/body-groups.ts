...
export function createGenderConfig(gender: "male" | "female"): GenderConfig {
  ...
  torso.measurements.torsoHeight = {
    type: "value",
    keys: ["torso_height"],
    min: 0,
    max: 1,
  ...
  const baseConfig: GenderConfig = {
    head: {
      ...
      measurements: {
        headShape: {
          type: "value",
          keys: ["shape_head_round", "shape_head_oblong", "shape_head_coned"],
          min: 0,
          max: gender === "male" ? 3 : 2,
          step: 1,
          ticks: gender === "male" ? 4 : 3,
        },
        headSize: { type: "value", keys: ["head_size"], min: 0, max: 1, step: 0.25, ticks: TICKS.medium },
      },
    },
    neck: {
      icon: "🦒",
      ...
      measurements: {
        neckHeight: {
          ...
          min: 0,
          max: 1,
          step: gender === "male" ? 0.2 : 0.25,
          ticks: gender === "male" ? 6 : 5,
        },
        neckWidth: {
          type: "value",
          keys: ["neck_width"],
          min: 0,
          max: 1,
          step: gender === "male" ? 0.25 : 0.5,
          ticks: gender === "male" ? 5 : 3,
        },
    ...
    legs: {
      ...
      measurements: {
        ...
        legSize: {
          ...
          min: 0,
          max: 1,
          step: gender === "male" ? 0.333 : 0.25,
          ticks: gender === "male" ? 4 : 5,
        },
