      ...
      <main className="flex-1">
        ...
        <section className="w-full h-screen relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
            <p className="text-sm font-medium mb-2 opacity-90"><a href="https://www.mirrormefashion.com" className="text-sm font-medium opacity-90 hover:no-underline focus:no-underline">by Mirror Me Fashion</a></p>
        ...
        <section className="hidden md:block w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            <div className="relative w-full h-full min-h-[300px]">
              <img src="images/bw-models-mountain.png" alt="Section 62" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/40" />
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
                <h2 className="text-3xl md:text-4xl mb-3">Support Independent Designers</h2>
                <p className="text-lg md:text-xl mb-6">Discover unique collections from emerging fashion talents around the world</p>
                <Link data-slot="button" href="/discover" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-secondary text-secondary-foreground hover:bg-secondary/80 h-10 rounded-md px-6 has-[&>svg]:px-4">
                  Discover Campaigns
                </Link>
              </div>
            ...
            <div className="relative w-full h-full min-h-[300px]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
                ...
                <p className="text-lg md:text-xl mb-6">Shop ethically-made collections that prioritize quality and the environment</p>
                <Link data-slot="button" href="/discover" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-secondary text-secondary-foreground hover:bg-secondary/80 h-10 rounded-md px-6 has-[&>svg]:px-4">
                  Learn More
                </Link>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-lg text-neutral-700 leading-relaxed">
                The Fashion Independent is a platform where talented designers can grow their brands by connecting with people like you 
                who want stylish, well-made fashion. Browse, buy, or vote on their collections. 
              </p>
              <p className="text-xl font-semibold mt-6 text-neutral-900">
                Discover the current generation of talent shaping the fashion industry
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-neutral-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
              Showcase your creative vision to a community of fashion enthusiasts and supporters who believe in independent design.
            </p>
