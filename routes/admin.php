...
Route::controller(SurveyController::class)->group(function () {
    ...
    Route::get('/survey', 'index')->name('surveys.index');
    Route::get('/surveys', 'create')->name('surveys.create');
    Route::post('/surveys', 'store')->name('surveys.store');
    Route::get('/surveys/{id}/edit', 'show')->name('surveys.edit');
    Route::post('/surveys/update', 'update')->name('surveys.update');
    Route::get('/surveys/{id}/destroy', 'destroy')->name('surveys.destroy');
});
Route::controller(QuestionController::class)->group(function () {

    Route::get('survey/questions', 'index')->name('questions.index');
    Route::post('survey/questions', 'store')->name('questions.store');
    Route::get('survey/questions/create', 'create')->name('questions.create');
    Route::get('survey/questions/{id}', 'edit')->name('questions.edit');
    Route::get('survey/questions/destroy/{id}', 'destroy')->name('questions.destroy');
});
Route::controller(FeedbackController::class)->group(function () {
    Route::get('survey/feedbacks', 'index')->name('feedbacks.index');
    Route::get('survey/feedbacks/{id}', 'show')->name('feedbacks.show');
    Route::get('survey/feedbacks/destroy/{id}', 'destroy')->name('feedbacks.destroy');
});
    ...
    // Campaigns - Fashion Independent
    Route::resource('campaigns', CampaignController::class, ['as' => 'admin']);
    Route::controller(CampaignController::class)->group(function () {
        Route::get('/campaigns/destroy/{id}', 'destroy')->name('admin.campaigns.destroy');
        Route::post('/campaigns/approve/{id}', 'approve')->name('admin.campaigns.approve');
        Route::post('/campaigns/reject/{id}', 'reject')->name('admin.campaigns.reject');
        Route::post('/campaigns/mark-live/{id}', 'markLive')->name('admin.campaigns.mark-live');
        Route::post('/campaigns/mark-completed/{id}', 'markCompleted')->name('admin.campaigns.mark-completed');
        Route::get('/campaigns-statistics', 'statistics')->name('admin.campaigns.statistics');
        Route::post('/campaigns/upload-images/{id}', 'uploadImages')->name('admin.campaigns.upload-images');
        Route::post('/campaigns/delete-image/{campaignId}/{imageIndex}', 'deleteImage')->name('admin.campaigns.delete-image');
    });
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        Route::post('/user_feedback/form', 'user_feedback_form_update')->name('user_feedback_form.update');
        ...
        Route::get('/user_feedback/form', 'user_feedback_form')->name('user_feedback_form.index');
        Route::post('/user_feedback/form', 'user_feedback_form_update')->name('user_feedback_form.update');
