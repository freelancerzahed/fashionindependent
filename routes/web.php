...
// Storage file serving route (without symlink requirement)
...
Route::controller(UsersController::class)->group(function () {
    Route::post('/users/registration',             'store')->name('user.registration');
    Route::post('/advertiser/registration', 'create_advertiser')->name('advertiser.registration');
});
...
Route::controller(PostController::class)->group(function () {
    Route::post('user/post-create','store')->name('create-post');
    Route::get('user/post-remove/{id}','destroy')->name('remove-post');
    Route::post('user/update-post/{id}','update')->name('update-post');
    Route::post('user/post-report','report')->name('report-post');
    Route::get('user/post/update/{id}','edit')->name('getpost-by-post');

});
Route::controller(LikeController::class)->group(function () {
    Route::post('/posts/like', 'store')->name('post.like');
    Route::post('/posts/comment-like', 'comment_like')->name('comment.like');
});
Route::controller(CommentController::class)->group(function () {
    Route::get('user/posts/comment/{id}/destroy', 'destroy')->name('comment.destroy');
});
Route::controller(MessageController::class)->group(function () {
    Route::get('user/messanger/{user_name}','index')->name('get-messanger');
    Route::post('user/send-messange','store')->name('send-message');
});
    ...
    Route::controller(SocialController::class)->group(function () {
        Route::get('user/profile/favorite','favorite')->name('favorite');

  Route::get('/user/profile/cart', 'cart')->name('view_cart');
    Route::post('user/send-comment','commentStore')->name('comment.add');
    Route::post('user/reply-comment','commentReplyStore')->name('comment.reply');
    Route::get('user/profile','getUserProfile')->name('get_user_profile');
    Route::post('user/profile/search-friends-ajax','search_friends_ajax')->name('search-friends-ajax');
    Route::post('user/profile/search-users','search_users')->name('search-users');
    Route::get('user/profile/settings','settings')->name('get-user-settings');
    Route::get('user/profile/friend-page','friend_page')->name('get-friend-page');
    Route::get('user/profile/messanger-page','messanger_page')->name('get-messanger-page');
    Route::get('user/profile/notification-page','notification_page')->name('get-notification-page');
    Route::get('user/profile/recommendational-history','recommendational_history')->name('get-recommendational-history');
    Route::get('user/profile/media-page','media_page')->name('get-media-page');
    Route::get('user/profile/body-shape-page','body_shape')->name('get-body-shape-page');
    Route::get('user/profile/edit-body-shape','edit_body_shape')->name('edit-body-shape');
    Route::post('user/profile-update','update_profile')->name('user.profile-update');
    Route::post('user/about-setting-update','about_setting_update')->name('user.about-setting-update');
    Route::post('user/body-shape-update','update_slider_values')->name('update.slider.values');
    Route::post('user/privecy-setting-update','privecy_setting_update')->name('user.privecy-setting-update');
    Route::post('user/notification-setting-update','notify_update')->name('user.is_notify');
    Route::post('user/change-password','change_password')->name('user.change-password');
    Route::post('user/profile-picture-change','profilePicChange')->name('user.profile-picture-change');
    Route::post('user/links-update','update_website_links')->name('user.website-links-update');
    Route::get('user/profile/{user_name}','index')->name('get-user-profile-page');
    ...
    Route::controller(FeedbackController::class)->group(function () {
        Route::get('/feedback/{id}','create')->name('feedback.create');
        Route::post('/feedback','store')->name('feedback.store');
    });

    Route::controller(FriendController::class)->group(function () {
        Route::post('profile/send-friend-request','sendFriendRequest')->name('send-friend-request');
        Route::post('profile/remove-friend','removeFriend')->name('remove-friend');
        Route::get('block-friend/{id}','blockFriend')->name('block-friend');
        Route::post('add-top-10-friend','addTop10Friend')->name('add-top-10-friend');
