<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                            ...
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.create'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Member list') }}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                <!-- Fashion Independent Campaigns -->
                @canany(['view_campaigns', 'edit_campaign', 'approve_campaign', 'delete_campaign'])
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('admin.campaigns.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.campaigns.index', 'admin.campaigns.show', 'admin.campaigns.edit', 'admin.campaigns.statistics']) }}">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path id="campaign" d="M14.5,1h-13A1.5,1.5,0,0,0,0,2.5v11A1.5,1.5,0,0,0,1.5,15h13a1.5,1.5,0,0,0,1.5-1.5V2.5A1.5,1.5,0,0,0,14.5,1ZM1,2.5a.5.5,0,0,1,.5-.5h13a.5.5,0,0,1,.5.5v8H1ZM1,13.5v-2H15v2a.5.5,0,0,1-.5.5h-13A.5.5,0,0,1,1,13.5Zm3-3a1,1,0,1,1,1,1A1,1,0,0,1,4,10.5Zm4,0a1,1,0,1,1,1,1A1,1,0,0,1,8,10.5Zm4,0a1,1,0,1,1,1,1A1,1,0,0,1,12,10.5Z" fill="#575b6a"/>
                                </svg>
                            </div>
  ...
  <li class="aiz-side-nav-item">
      <a href="#" class="aiz-side-nav-link">
          ...
          <span class="aiz-side-nav-text">{{ translate('Survey') }}</span>
          <span class="aiz-side-nav-arrow"></span>
      </a>
      <ul class="aiz-side-nav-list level-2">
          @can('view_all_customers')
              <li class="aiz-side-nav-item">
                  <a href="{{ route('surveys.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.create'])}}">
                      <span class="aiz-side-nav-text">{{ translate('Surveies') }}</span>
                  </a>
              </li>
              <li class="aiz-side-nav-item">
                <a href="{{ route('questions.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.create'])}}">
                    <span class="aiz-side-nav-text">{{ translate('Questions') }}</span>
                </a>
            </li>
            <li class="aiz-side-nav-item">
                <a href="{{ route('feedbacks.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.create'])}}">
