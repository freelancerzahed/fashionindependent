...
export async function POST(req: Request) {
  try {
    ...
    const endpoint = `${BACKEND_URL}${AUTH_CONFIG.signupEndpoint}`;
    console.log("[Auth Signup API] Forwarding to:", endpoint);
    console.log("[Auth Signup API] Request body:", { ...body, password: "***" });
