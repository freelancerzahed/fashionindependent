...
export default function HomePage() {
  const campaigns = Array.from({ length: 6 }, (_, i) => ({
    ...
    pledgeOptions: [
      { id: `pledge-${i}-1`, amount: 50, description: "Early Bird" },
      { id: `pledge-${i}-2`, amount: 100, description: "Standard" },
      { id: `pledge-${i}-3`, amount: 250, description: "Premium" },
    ],
  ...
  const heroSlides = [
    {
      ...
      image: "/fashion-independent-hero.jpg",
    ...
    },
    {
      ...
      image: "/independent-fashion-designers.jpg",
      ctaText: "Launch a Campaign",
      ctaLink: "/launch-campaign",
    },
    {
      title: "Sustainable Fashion",
      subtitle: "Eco-Conscious Designs",
      description: "Discover planet-conscious fashion before it becomes mainstream",
      image: "/eco-fashion.png",
      ctaText: "Shop Now",
      ctaLink: "/shop",
    },
  ]
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-lg text-neutral-700 leading-relaxed">
                The high cost of launching a fashion business prevents talented designers from entering the fashion
                industry, which is why The Fashion Independent was born. On this platform, designers worldwide can
