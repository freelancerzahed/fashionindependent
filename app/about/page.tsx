        ...
        <section className="py-20 bg-gradient-to-br from-neutral-50 to-neutral-100">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-neutral-600 mb-12">Creatives in the spotlight</p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-neutral-700 leading-relaxed">
                <p>
                  ...
                  stylish, obscure, planet-conscious fashion before it becomes mainstream.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                ...
                <div className="text-center">
                  <div className="bg-neutral-100 rounded-lg p-8 mb-4">
                    <div className="text-4xl mb-2">👗</div>
                    <h3 className="font-semibold text-lg">Get Fashion</h3>
                  </div>
                  <Button variant="outline" asChild className="w-full bg-transparent">
