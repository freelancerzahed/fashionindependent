              ...
              <Card className="p-8">
                ...
                <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-900">
                    <strong>Note:</strong> We verify all creators to protect our community from fraudulent activities.
                    All creators agree to our partnership terms and cannot sell products outside our platform.
                  </p>
                </div>
              </Card>
            </div>
