              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    ...
                    backers who appreciate unique, sustainable fashion.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    Designers launch campaigns with a funding goal and timeline (typically 30 days). Backers pledge
                    money to support campaigns they love. If a campaign reaches its minimum pledge requirement (10
                    backers), it's successful and the designer receives the funds to produce the items.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent>
                    Standard campaigns have 60 days to deliver after successful funding. Designers using our
                    manufacturing services typically deliver within 7-30 days. Luxury/handmade items have up to 90 days
                    for delivery.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-7">
                  ...
                  <AccordionContent>
                    ...
                    maintenance, and designer support. Detailed fee information is available in our Partnership
                    Agreement.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-8">
                  ...
                  <AccordionContent>
                    ...
                    minimizes waste, and operates efficiently. Unlike fast fashion, we focus on quality,
                    well-constructed items made to last.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
